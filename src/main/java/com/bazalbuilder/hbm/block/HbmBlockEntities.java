...
public class HbmBlockEntities {
	public static final BlockEntityType<ShredderBlockEntity> SHREDDER_BLOCK_ENTITY;

	private static void registerBlockEntityTypes() {
		RegistryUtils.registerBlockEntityType("shredder", SHREDDER_BLOCK_ENTITY);
	}
	...
	static {
		SHREDDER_BLOCK_ENTITY = BlockEntityType.Builder.create(ShredderBlockEntity::new, HbmBlocks.SHREDDER).build();
