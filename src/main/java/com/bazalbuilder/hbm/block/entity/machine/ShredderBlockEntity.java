...
public class ShredderBlockEntity extends AbstractMachineBlockEntity implements SidedInventory, EnergyReceiver, Nameable {
	public ShredderBlockEntity(BlockPos pos, BlockState state) {
		super(HbmBlockEntities.SHREDDER_ENTITY, pos, state, 30);
	}
